...
from src.models.modules.attention.projection_utils import gaussian_orthogonal_random_matrix
...
class PerformerAttention(nn.Module):
    ...
    def forward(self, query, key, value, attn_mask=None, key_padding_mask=None, need_weights=False):
        ...
        if key_padding_mask is not None and not key_padding_mask.all_ones:
            ...
            value.masked_fill_(rearrange(~key_padding_mask.bool_matrix, 'b s -> b 1 s 1'), 0.0)
