# Copied from https://github.com/rwightman/pytorch-image-models/blob/master/timm/loss/binary_cross_entropy.py
# Since it's not in the released version of timm yet [2021-11-14].
