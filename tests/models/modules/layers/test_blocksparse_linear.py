...
from src.models.modules.layers.blocksparse_linear import BlockSparseLinear
from src.models.modules.layers.fastlinear import NinjaTurtleLinear, ButterflyGlobalLinear
from src.models.modules.attention.blocksparse_utils import sparsify_tensor, densify_tensor
from src.models.modules.attention.blocksparse_utils import mask_tensor
...
class TestBlockSparseLinear:
    ...
    def test_output(self, in_features, out_features, block_size):
        ...
        with torch.no_grad():
            ...
            weight_sparse = sparsify_tensor(rearrange(weight_dense, 'd2 d1 -> 1 1 d2 d1'),
                                            bs_linear.layout, bs_linear.block_size)
