...
from src.models.modules.layers.blocksparse_linear import BlockSparseLinear, FlatBlockButterflySparsityConfig
...
class TestFlatBlockButterflySparsityConfig:
    ...
    def test_parameters_512(self, butterfly_size, n_factors, block_size):
        ...
        s_cfg = {'_target_': 'src.models.modules.layers.blocksparse_linear.FlatBlockButterflySparsityConfig',
